...
static const char *scrotpartialcmd[] = {"scrot-partial.sh", NULL};
/* static const char *togglelayoutscmd[] = {"toggle_keyboard_layout.sh", NULL}; */

Autostarttag autostarttaglist[] = {
	{.cmd = browsercmd, .tags = 1 << 0 },
	{.cmd = keepassxccmd, .tags = 1 << 4 },
	{.cmd = telegramcmd, .tags = 1 << 8 },
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_grave,  spawn,          {.v = clipmenucmd } },
	{ MODKEY,                       XK_p,      spawn,          {.v = dmenucmd } },
	{ MODKEY|ShiftMask,             XK_Return, spawn,          {.v = termcmd } },
	{ MODKEY|ShiftMask,             XK_F8,     spawn,          {.v = scrotpartialcmd } },
